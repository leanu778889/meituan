...
<body>
	...
	<!-- 商品过滤结束 -->
	<link href="http://localhost/meituan/APP/App/Index/Tpl/Public/css/index.css" type="text/css" rel="stylesheet" >
	<!-- 页面主体开始 -->
	<div id="main">
		<div class='content'>
			...
			<div class='item'>
				<div class='cover'>
					<a href="<?php echo U('Index/Detail/index');?>/gid/<?php echo $v['gid'];?>"><img src="http://localhost/meituan/<?php echo $v['goods_img'];?>"/></a>
				</div>
			...
			<div class='hot-products'>
				...
				<ul>
					<?php if(is_array($hotGoods)):?><?php  foreach($hotGoods as $k=>$v){ ?>
						<li>
							<h6><span><?php echo $k;?></span><a href="<?php echo U('Index/Detail/index');?>/gid/<?php echo $v['gid'];?>"><?php echo $v['main_title'];?></a></h6>
