...
final class Route
{
    ...
    {
        //请求内容
        $query = C('URL_TYPE') == 2 && isset($_GET[C("PATHINFO_VAR")]) ? $_GET[C("PATHINFO_VAR")] :
    ...
    static private function setConst()
    {
        ...
        defined("__GROUP__") or define("__GROUP__", __ROOT__ . '/' . str_replace(ROOT_PATH, '', str_replace('\\', '/', realpath(GROUP_PATH))));
        //网站根-Static目录
        defined("__TPL__") or define("__TPL__", __ROOT__ . '/' . str_replace(ROOT_PATH, '', str_replace('\\', '/', realpath(TPL_PATH))));
        ...
        defined("__TEMPLATE__") or define("__TEMPLATE__", __ROOT__ . '/Template');
    }
