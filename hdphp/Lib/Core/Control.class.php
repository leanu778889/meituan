...
abstract class Control
{
     ...
     * @return mixed
     */
    protected function display($tplFile = null, $cacheTime = null, $cachePath = null, $contentType = "text/html", $charset = "", $show = true)
    {
        $this->getViewObj();
        //执行视图对象中的display同名方法
    ...
    {
        $this->getViewObj();
        return $this->view->fetch($tplFile, $cacheTime, $cachePath = null, $contentType, $charset, $show);
    }
    ...
    protected function error($msg = "", $url = "", $time = 2, $tpl = null)
    {
        ...
        //模板文件
        $tpl_file = ($tpl ? $tpl : 'error') . C("TPL_FIX");
     ...
     * @return void
     */
    protected function success($msg = "", $url = "", $time = 2, $tpl = null)
    {
        $msg = $msg ? $msg : L("control_success_msg");
        //模板文件
        $tpl_file = ($tpl ? $tpl : 'success') . C("TPL_FIX");
        $this->_error_success($msg, $url, $time, $tpl_file);
        exit;
    }
